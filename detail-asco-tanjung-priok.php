...
<html>
  ...
  <div class="container-fluid">
    ...
    <script>
      ...
      function initMap() {
        var myLatLng = {lat: -6.1894081, lng: 106.8297698};
        ...
        var marker = new google.maps.Marker({
          position: myLatLng,
          map: map,
          title: 'Asco Automotive Tanjung Priok, Jakarta Utara, DKI Jakarta, Jl. Kramat Jaya No. 14 A-B Semper Barat, Jakarta Utara'
        });
      }
    </script>
    <script async defer
